...
if __name__ == "__main__":
    ...
    for index in range(3):
        ...
        golden_img = golden_img.convert('L') # convert to 8 bits
        ...
        golden = Image.fromarray(golden_img_array)
        golden.save(origin_path)
